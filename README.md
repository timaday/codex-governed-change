...
| Acceptance suite | `GREEN_LOCAL` | The current unit and acceptance suite passes locally without skips or expected failures; `IMPLEMENTATION_STATUS.md` records the latest exact working-copy count. |
